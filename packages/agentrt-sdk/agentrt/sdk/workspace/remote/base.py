...
from agentrt.sdk.git.models import GitChange, GitDiff
from agentrt.sdk.logger import get_logger
from agentrt.sdk.mcp.config import MCPServer
from agentrt.sdk.settings import SecretsListResponse, SettingsResponse
...
from agentrt.sdk.workspace.remote.remote_workspace_mixin import RemoteWorkspaceMixin
...
class RemoteWorkspace(RemoteWorkspaceMixin, BaseWorkspace):
    ...
    def _convert_skill_data_to_skill(self, skill_data: dict[str, Any]) -> "Skill":
        ...
        Returns:
            Skill object
        """
        from agentrt.sdk.skills import KeywordTrigger, Skill, TaskTrigger
    ...
    def load_skills_from_agent_server(
        ...
        Args:
            ...
            load_user: Load user skills from ~/.agentrt/skills/.
