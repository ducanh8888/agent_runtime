...
off disk is delegated to a :class:`~agentrt.sdk.plugin.format.PluginFormat`
...
from agentrt.sdk.plugin.fetch import fetch_plugin
from agentrt.sdk.plugin.format import detect_format
...
class Plugin(BaseModel):
    ...
    def fetch(
        ...
        Args:
            ...
            cache_dir: Directory for caching. Defaults to ~/.agentrt/cache/plugins/
