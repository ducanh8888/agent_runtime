...
Delegates to :mod:`agentrt.sdk.extensions.fetch` for the actual fetch logic
...
from agentrt.sdk.extensions.fetch import (
    ExtensionFetchError,
    fetch_with_resolution as _ext_fetch_with_resolution,
)
from agentrt.sdk.git.cached_repo import GitHelper
