...
directory into a normalized :class:`~agentrt.sdk.plugin.Plugin`. Everything
...
from agentrt.sdk.plugin.format.agent_plugins import AgentPluginsFormat
from agentrt.sdk.plugin.format.base import PluginFormat
from agentrt.sdk.plugin.format.claude_code import ClaudeCodePluginFormat
