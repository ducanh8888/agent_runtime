...
from agentrt.sdk.conversation.request import SendMessageRequest
...
from agentrt.sdk.utils.pydantic_secrets import (
    serialize_secret,
    validate_secret,
)
...
if TYPE_CHECKING:
    ...
    from agentrt.sdk.critic.base import CriticBase
...
class NoOpCondenserSettings(CondenserSettings):
    ...
    def build_condenser(self, llm: LLM) -> CondenserBase | None:  # noqa: ARG002
        ...
        from agentrt.sdk.context.condenser import NoOpCondenser
...
:data:`~agentrt.sdk.settings.acp_providers.ACP_PROVIDERS`.
"""
...
class AgentrtAgentSettings(AgentSettingsBase):
    ...
    tools: list[Tool] | None = Field(
        ...
        description=(
            ...
            "standard exec set (see agentrt.sdk.tool.defaults), plus the "
    ...
    def create_agent(self) -> Agent:
        ...
        from agentrt.sdk.tool.builtins import BUILT_IN_TOOLS, SwitchLLMTool
        from agentrt.sdk.tool.defaults import default_tool_specs
...
class ACPAgentSettings(AgentSettingsBase):
    ...
    acp_isolate_data_dir: bool = Field(
        ...
        description=(
            ...
            ":attr:`~agentrt.sdk.agent.ACPAgent.acp_isolate_data_dir`; off by "
    ...
    def api_key_env_var(self) -> str | None:
        ...
        Delegates to the :data:`~agentrt.sdk.settings.acp_providers.ACP_PROVIDERS`
    ...
    def resolve_acp_command(self) -> list[str]:
        ...
        up the default from :data:`~agentrt.sdk.settings.acp_providers.ACP_PROVIDERS`.
...
def create_agent_from_settings(
    ...
    Returns either :class:`~agentrt.sdk.agent.Agent` (LLM variant) or
    :class:`~agentrt.sdk.agent.ACPAgent` (ACP variant).
    """
