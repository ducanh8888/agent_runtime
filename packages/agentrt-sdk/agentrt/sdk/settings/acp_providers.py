...
class ACPFileSecretSpec(BaseModel):
    ...
    :attr:`secret_name` — and :class:`~agentrt.sdk.agent.ACPAgent` materialises
    ...
    :attr:`~agentrt.sdk.agent.ACPAgent.acp_file_secrets` to support other ACP
...
class ACPProviderInfo:
    ...
    pointing at it) that :class:`~agentrt.sdk.agent.ACPAgent` materialises
    ...
    :meth:`~agentrt.sdk.settings.model.ACPAgentSettings.resolve_acp_command`
    ...
    :attr:`~agentrt.sdk.agent.ACPAgent.acp_isolate_data_dir`.
    """
    ...
    :class:`~agentrt.sdk.agent.ACPAgent` only for the provider that declares
...
# launcher now lives in ACP_INSTALL_CATALOG (agentrt.sdk.settings.
...
def default_acp_file_secrets() -> tuple[ACPFileSecretSpec, ...]:
    ...
    :attr:`~agentrt.sdk.agent.ACPAgent.acp_file_secrets`, which a downstream
