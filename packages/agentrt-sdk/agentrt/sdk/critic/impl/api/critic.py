...
from agentrt.sdk.critic.base import CriticBase, CriticResult
from agentrt.sdk.critic.impl.api.client import CriticClient
from agentrt.sdk.critic.impl.api.taxonomy import categorize_features
...
class APIBasedCritic(CriticBase, CriticClient):
    ...
    def evaluate(
        ...
        from agentrt.sdk.event import LLMConvertibleEvent, SystemPromptEvent
