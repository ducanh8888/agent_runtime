...
from agentrt.sdk.utils.path import get_user_persistence_dir, to_posix_path
...
* When asked to find a previous local Agentrt conversation, search the workspace's `workspace/conversations/` directory for its event history.
...
- Agentrt capabilities (e.g., "can Agentrt do...", "does Agentrt have...")
- what you're able to do in second person (e.g., "are you able...", "can you...")
- how to use a specific Agentrt feature or product
- how to use the Agentrt SDK, CLI, GUI, or other Agentrt products

Get accurate information from the official Agentrt documentation at <https://docs.openhands.dev/>. The documentation includes:

**Agentrt SDK** (`/sdk/*`): Python library for building AI agents; Getting Started, Architecture, Guides (agent, llm, conversation, tools), API Reference
**Agentrt CLI** (`/openhands/usage/run-openhands/cli-mode`): Command-line interface
**Agentrt GUI** (`/openhands/usage/run-openhands/local-setup`): Local GUI and REST API
**Agentrt Cloud** (`/openhands/usage/run-openhands/cloud`): Hosted solution with integrations
**Agentrt Enterprise**: Self-hosted deployment with extended support
...
* **AI disclosure**: When posting messages, comments, issues, or any content to external services that will be read by humans (e.g., Slack messages, GitHub/GitLab comments, PR/MR descriptions, Discord messages, Linear/Jira issues, Notion pages, emails, etc.), always include a brief note indicating the content was generated by an AI agent on behalf of the user. For example, you could add a line like: _"This [message/comment/issue/PR] was created by an AI agent (Agentrt) on behalf of [user]."_ This applies to any communication channel — whether through dedicated tools, MCP integrations, or direct API calls.
</EXTERNAL_SERVICES>"""
