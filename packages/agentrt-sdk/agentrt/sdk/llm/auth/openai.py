...
from agentrt.sdk.llm.auth.credentials import (
    CredentialStore,
    OAuthCredentials,
    get_credentials_dir,
)
    ...
    def create_llm(
        ...
        **llm_kwargs: Any,
        ...
        extra_headers: dict[str, str] = {
            ...
            "User-Agent": f"agentrt-sdk ({platform.system()}; {platform.machine()})",
        }
        if account_id:
...
async def subscription_login_async(
    ...
    **llm_kwargs: Any,
    ...
    Example:
        >>> import asyncio
        >>> from agentrt.sdk.llm.auth import subscription_login_async
