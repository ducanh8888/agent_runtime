...
from agentrt.sdk.llm.utils.runtime_metadata import (
...
from agentrt.sdk.settings.metadata import SettingProminence, field_meta
from agentrt.sdk.utils.deprecation import warn_deprecated
from agentrt.sdk.utils.pydantic_secrets import serialize_secret, validate_secret


if TYPE_CHECKING:  # type hints only, avoid runtime import cycle
    from agentrt.sdk.llm.auth import SupportedVendor
    from agentrt.sdk.llm.auth.openai import OpenAIAuthMethod
    from agentrt.sdk.tool.tool import ToolDefinition

from agentrt.sdk.llm.auth.openai import transform_for_subscription
...
from agentrt.sdk.llm.mixins.non_native_fc import NonNativeToolCallingMixin
...
from agentrt.sdk.llm.utils.image_inline import (
    amaybe_inline_image_urls,
    maybe_inline_image_urls,
)
from agentrt.sdk.llm.utils.image_resize import maybe_resize_messages_for_provider
...
from agentrt.sdk.logger import ENV_LOG_DIR, get_logger
    ...
    def subscription_login(
        ...
        **llm_kwargs,
        ...
        Example:
            ...
            ```
        """
        from agentrt.sdk.llm.auth.openai import subscription_login
