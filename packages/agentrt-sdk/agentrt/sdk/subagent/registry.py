...
Example usage:
    from agentrt.sdk import register_agent, Agent, AgentContext
...
def agent_definition_to_factory(
    ...
    if agent_def.skills:
        from agentrt.sdk.skills import load_available_skills
...
def register_file_agents(work_dir: str | Path) -> list[str]:
    ...
    `.agentrt/agents`, and user-level `~/.agents/agents` and `~/.agentrt/agents`
    directories.
