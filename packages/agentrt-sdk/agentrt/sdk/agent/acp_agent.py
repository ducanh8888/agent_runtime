...
from agentrt.sdk.agent.acp_tracing import ACPTurnTrace
...
from agentrt.sdk.llm import LLM, ImageContent, Message, MessageToolCall, TextContent
from agentrt.sdk.logger import get_logger
from agentrt.sdk.mcp.config import MCPServer
from agentrt.sdk.observability.laminar import maybe_init_laminar, observe
...
from agentrt.sdk.tool import Tool  # noqa: TC002
from agentrt.sdk.tool.builtins.finish import FinishAction, FinishObservation
from agentrt.sdk.utils import maybe_truncate
from agentrt.sdk.utils.pydantic_secrets import (
    serialize_secret,
    validate_secret,
)
from agentrt.sdk.utils.redact import redact_text_secrets
...
class ACPAgent(AgentBase):
    ...
    def supports_runtime_model_switch(self) -> bool:
        ...
        See
        :meth:`~agentrt.sdk.conversation.impl.local_conversation.LocalConversation.switch_acp_model`.
        """
