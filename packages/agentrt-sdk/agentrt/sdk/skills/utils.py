...
from agentrt.sdk.git.cached_repo import GitHelper, try_cached_clone_or_update
...
if TYPE_CHECKING:
    from agentrt.sdk.skills.skill import Skill, SkillResources
...
def load_and_categorize(
    ...
    from agentrt.sdk.skills.skill import Skill
...
def get_skills_cache_dir() -> Path:
    ...
    Returns:
        ...
        directory (``~/.agentrt/cache/skills`` absent AGENTRT_PERSISTENCE_DIR).
    """
...
def update_skills_repository(
    ...
    Uses the shared git caching infrastructure from agentrt.sdk.git.cached_repo.
...
def discover_skill_resources(skill_dir: Path) -> SkillResources:
    ...
    """
    # Import here to avoid circular dependency
    from agentrt.sdk.skills.skill import SkillResources
