...
def sanitize_openhands_mentions(text: str) -> str:
    """Sanitize @Agentrt mentions in text to prevent self-mention loops.

    This function inserts a zero-width joiner (ZWJ) after the @ symbol in
    @Agentrt mentions, making them non-clickable in GitHub comments while
    ...
    Returns:
        Text with sanitized @Agentrt mentions (e.g., "@Agentrt" -> "@‍Agentrt")

    Examples:
        >>> sanitize_openhands_mentions("Thanks @Agentrt for the help!")
        'Thanks @\\u200dOpenHands for the help!'
        >>> sanitize_openhands_mentions("Check @openhands and @AGENTRT")
        'Check @\\u200dopenhands and @\\u200dOPENHANDS'
        >>> sanitize_openhands_mentions("No mention here")
        'No mention here'
    """
    # Pattern to match @Agentrt mentions at word boundaries
