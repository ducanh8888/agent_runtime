"""Build the default :class:`~agentrt.sdk.profiles.AgentProfile` from live settings.

The inverse of :func:`~agentrt.sdk.profiles.resolve_agent_profile`: turns the
...
if TYPE_CHECKING:
    from agentrt.sdk.settings import AgentSettingsConfig
