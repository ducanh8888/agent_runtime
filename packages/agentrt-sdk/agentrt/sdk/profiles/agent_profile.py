...
:data:`~agentrt.sdk.settings.model.AgentSettingsConfig`: the profile carries
...
class ProfileVerificationSettings(BaseModel):
    ...
    :class:`~agentrt.sdk.settings.model.VerificationSettings`: ``critic_api_key``
...
class ACPAgentProfile(AgentProfileBase):
    ...
    :data:`~agentrt.sdk.settings.acp_providers.ACP_PROVIDERS` registry. The
