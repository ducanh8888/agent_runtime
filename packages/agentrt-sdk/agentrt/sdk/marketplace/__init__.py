...
from agentrt.sdk.marketplace.registration import (
...
def __getattr__(name: str) -> Any:
    if name in _TYPE_EXPORTS:
        return getattr(import_module("agentrt.sdk.marketplace.types"), name)
    if name in _REGISTRY_EXPORTS:
        return getattr(import_module("agentrt.sdk.marketplace.registry"), name)
