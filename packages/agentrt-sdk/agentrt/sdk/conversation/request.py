...
from agentrt.sdk.agent.acp_agent import ACPAgent as ACPAgent
from agentrt.sdk.agent.agent import Agent as Agent
...
from agentrt.sdk.utils.models import kind_of
...
class ConversationConfig(BaseModel):
    ...
    title_llm_profile: str | None = Field(
        ...
        description=(
            ...
            "is loaded from LLMProfileStore (~/.agentrt/profiles/) and used "
