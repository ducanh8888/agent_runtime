...
# agentrt-sdk[vertex] extra first, or pass ENABLE_VERTEX=1 to the Docker build,
...
if _VERTEX_AVAILABLE:
    ...
    print(
        ...
        "Install agentrt-sdk[vertex] before building to include it."
    )
...
PATHEX = [
    project_root / "agentrt-server",
    project_root / "agentrt-sdk",
    project_root / "agentrt-tools",
    project_root / "agentrt-workspace",
]
...
a = Analysis(
    ...
    datas=[
        ...
        *collect_data_files("agentrt.tools.preset", includes=["subagents/*.md"]),

        # Package metadata for importlib.metadata
        *copy_metadata("agentrt-server"),
        *copy_metadata("agentrt-sdk"),
        *copy_metadata("agentrt-tools"),
        *copy_metadata("agentrt-workspace"),
    ...
    hiddenimports=[
        ...
        *collect_submodules("agentrt.agent_server"),
        ...
        *collect_submodules("rich"),
        ...
        # if agentrt-sdk[vertex] is not installed in the build env).
        *_vertex_hiddenimports,
