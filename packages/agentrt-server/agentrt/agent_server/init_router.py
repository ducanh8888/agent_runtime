...
from agentrt.agent_server.config import Config, TelemetrySpec, WebhookSpec
from agentrt.agent_server.conversation_service import ConversationService
from agentrt.agent_server.server_details_router import mark_initialization_complete
...
from agentrt.sdk.observability import maybe_init_laminar
...
class InitService:
    ...
    async def initialize(self, req: InitRequest) -> InitStatus:
        ...
        try:
            ...
            from agentrt.agent_server.api import _get_root_path
