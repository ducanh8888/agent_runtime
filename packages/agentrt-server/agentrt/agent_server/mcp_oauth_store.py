...
This adapter maps FastMCP's token/client-info/expiry keys onto Agentrt
...
from agentrt.agent_server.persistence import PersistedSettings, get_settings_store
