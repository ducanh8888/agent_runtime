...
from agentrt.sdk.logger import IN_CI, get_logger, rolling_log_view
...
from agentrt.sdk.workspace import PlatformType, TargetType
...
def _default_sdk_project_root() -> Path:
    ...
    def _is_workspace_root(d: Path) -> bool:
        ...
        _EXPECTED = (
            "agentrt-sdk/pyproject.toml",
            "agentrt-tools/pyproject.toml",
            "agentrt-workspace/pyproject.toml",
            "agentrt-server/pyproject.toml",
        )
