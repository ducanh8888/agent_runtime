...
def _write_repo_with_vendor_files(root: Path, baseline_source: str) -> None:
    ...
    Args:
        ...
        baseline_source: Either "repo_md" (legacy .agentrt/skills/repo.md)
...
# - "repo_md": Legacy .agentrt/skills/repo.md (still supported for existing repos)
