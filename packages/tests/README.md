...
- **SDK Tests** (`sdk/`): Run when changes are detected in `agentrt-sdk/**` or `tests/sdk/**`
- **Tools Tests** (`tools/`): Run when changes are detected in `agentrt-tools/**` or `tests/tools/**`
