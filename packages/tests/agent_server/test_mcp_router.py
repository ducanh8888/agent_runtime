...
from agentrt.agent_server.mcp_router import (
...
from agentrt.sdk.mcp.config import MCPServer, to_fastmcp_mcp_config
...
def test_mcp_test_decrypts_encrypted_remote_auth_before_connect(
    ...
    monkeypatch.setattr(
        "agentrt.agent_server.mcp_router.create_mcp_tools",
...
def test_mcp_oauth_start_returns_authorization_url_and_final_state(
    ...
    monkeypatch.setattr(
        "agentrt.agent_server.mcp_router._oauth_auth_from_authentication",
...
def test_browser_coordinated_oauth_callback_handler_uses_fastmcp_callback_api(
    ...
    monkeypatch.setattr(
        "agentrt.agent_server.mcp_router.create_oauth_callback_server",
