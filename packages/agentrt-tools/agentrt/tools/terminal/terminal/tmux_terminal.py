...
from agentrt.tools.terminal.env import (
    build_terminal_env,
    normalize_terminal_env,
)
from agentrt.tools.terminal.metadata import CmdOutputMetadata
from agentrt.tools.terminal.terminal import TerminalInterface
from agentrt.tools.terminal.terminal.interface import parse_ctrl_key
...
class TmuxTerminal(TerminalInterface):
    ...
    def is_running(self) -> bool:
        ...
        try:
            ...
            from agentrt.tools.terminal.constants import CMD_OUTPUT_PS1_END
