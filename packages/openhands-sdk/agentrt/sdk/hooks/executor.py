...
from agentrt.sdk.agent.utils import make_llm_completion
...
from agentrt.sdk.hooks.types import HookDecision, HookEvent
from agentrt.sdk.llm import Message, TextContent, content_to_str
from agentrt.sdk.observability.laminar import observe
from agentrt.sdk.utils import sanitized_env
...
class HookExecutor:
    ...
    def _execute_agent_hook(
        ...
        from agentrt.sdk.agent import Agent  # type: ignore[attr-defined]
