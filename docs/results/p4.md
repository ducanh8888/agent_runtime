...
[../research/p4-recon.md](../research/p4-recon.md) for what was probed.
...
that found the hard link. Like `6ff256c9` in `p3.md`, it looks
...
[p2.md](p2.md): tests asserting a *default* path while the run
...
work from inside Claude Code, which is recorded in `p3.md` and in
`../research/friction-log.md`.
